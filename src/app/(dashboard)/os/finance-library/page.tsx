...
const BOOK_DESCRIPTIONS: Record<string, string> = {
  ...
  // ── NEW BOOKS (from Google Drive, Mar 2026) ──
  '[Hoyt_Barber]_Tax_Havens_Today_The_Benefits_and_.pdf': 'Comprehensive guide to international tax havens — how they work, legal strategies for asset protection, and the benefits and pitfalls of offshore banking. Covers jurisdictions, compliance, and practical implementation for wealth preservation.',
  '7 habits of highly effective people.pdf': 'Stephen Covey\'s legendary framework for personal effectiveness. The 7 habits — from being proactive to sharpening the saw — provide a principle-centered approach to solving personal and professional problems.',
  'A Random Walk Down Wall Street.pdf': 'Burton Malkiel\'s classic argument for efficient markets and index investing. Covers stocks, bonds, real estate, and why most active managers underperform. The intellectual foundation for passive investing.',
  'A Short Course in Technical Trading - PERRY J KAUFMAN.pdf': 'Perry Kaufman distills decades of quantitative trading research into a practical short course. Covers trend-following, mean reversion, moving averages, and system development with clear rules.',
  'Candlesticks Made Easy.pdf': 'Simplified guide to candlestick charting — the essential patterns broken down for quick learning. Focuses on the most reliable formations with real chart examples and entry/exit rules.',
  'Daniel Reingold- Confessions of Wall Street Insider.pdf': 'A former top Wall Street telecom analyst reveals the conflicts of interest, backroom deals, and ethical compromises that define the Street. An insider\'s view of how the game is really played.',
  'ElWave.pdf': 'Elliott Wave analysis software guide and methodology. Covers wave counting, pattern identification, and how to use Elliott Wave theory for forecasting market turns and extensions.',
  'Following The Rules.pdf': 'Discipline-focused trading guide emphasizing the importance of following your trading plan without deviation. Covers rule creation, backtesting, and the psychology of consistent execution.',
  'FOREX THE CORE OF PRICE ACTION WITH 3W SYSTEM - SUMIT DAS.pdf': 'Sumit Das\'s 3W system for forex price action trading — Where, When, and What. A structured approach to reading naked charts without indicators, focusing on supply/demand zones and market structure.',
  'Forex Wave Theory.pdf': 'Applies wave analysis to the forex market — Elliott Wave, Wolfe Waves, and harmonic patterns specifically calibrated for currency pair behavior and the 24-hour forex cycle.',
  'How to Profit in Gold.pdf': 'Strategies for trading and investing in gold — physical, ETFs, futures, and mining stocks. Covers the macro drivers of gold prices, seasonal patterns, and portfolio allocation strategies.',
  'Inside a Traders Mind.pdf': 'Psychological deep-dive into the mental processes of successful traders. How they think about risk, handle losses, maintain discipline, and stay focused during volatile markets.',
  'Investment Philosophies - Aswath Damodaran.pdf': 'Damodaran — the dean of valuation — examines every major investment philosophy: value, growth, momentum, market timing, indexing. Each is analyzed with data, not dogma. Find the philosophy that fits YOU.',
  'Law of Success.pdf': 'Napoleon Hill\'s original masterwork (before Think and Grow Rich). Sixteen principles of success drawn from interviews with the most powerful people of the early 20th century. The original self-improvement blueprint.',
  'LEFT_Brain_Trading_the_right_mindset.pdf': 'Bridges the gap between analytical (left brain) and intuitive (right brain) trading. Teaches how to develop a balanced approach that leverages both systematic analysis and market feel.',
  'MajorSignals.pdf': 'Comprehensive guide to major technical signals — breakouts, reversals, continuation patterns. Each signal is cataloged with entry rules, stop placement, and historical success rates.',
  'Moving Averages.pdf': 'Deep dive into moving average strategies — simple, exponential, weighted, adaptive. Crossover systems, envelope strategies, and how to use MAs as dynamic support/resistance.',
  'PA.pdf': 'Price action trading methodology — reading raw price movement without indicators. Covers bar patterns, market structure, support/resistance, and how to build a complete trading plan from price alone.',
  'Price Action Trading.pdf': 'Comprehensive price action guide covering candlestick patterns, chart patterns, trend analysis, and how to execute trades based purely on what price is doing at key levels.',
  'Rich Dad Poor Dad.pdf': 'Robert Kiyosaki\'s paradigm-shifting book on financial literacy. The difference between assets and liabilities, why the rich don\'t work for money, and how to build wealth through financial education.',
  'Risk_Management_in_Trading_Techniques.pdf': 'Detailed risk management framework for active traders. Position sizing models, stop-loss strategies, portfolio heat management, correlation risk, and how to survive drawdowns without blowing up.',
  'Secrets of Swiss Banking.pdf': 'Inside look at the Swiss banking system — privacy, asset protection, wealth management strategies. Covers legal ways to use Swiss financial infrastructure for international diversification.',
  'Secrets of The Millionaire Mind.pdf': 'T. Harv Eker identifies the mental money blueprints that separate the wealthy from everyone else. Covers the psychology of wealth, limiting beliefs about money, and how to rewire your financial mindset.',
  'Sherman,_Howard_J_Economics___an.pdf': 'Academic economics introduction covering micro and macro fundamentals — market structures, monetary policy, fiscal policy, international trade. A solid foundation in how economies actually function.',
  'Stephen_Vines_Market_Panic__Wild.pdf': 'Analysis of market panics throughout history — what triggers them, how they spread, and how they end. From tulip mania to modern flash crashes. Understanding panic is the first step to profiting from it.',
  'Supply and Demand.pdf': 'Trading using supply and demand zones — identifying institutional order blocks, fresh vs tested levels, and how to trade the imbalances between buyers and sellers at key price areas.',
  'The 4 Hour Work Week.pdf': 'Tim Ferriss\'s manifesto on lifestyle design — automation, outsourcing, and building location-independent income. The principles of effectiveness over efficiency and designing life before career.',
  'The 4 Pillars of Profit Driven Marketing.pdf': 'Data-driven marketing framework built on four pillars: customer value, analytics, strategy, and execution. Bridges the gap between marketing spend and measurable profit impact.',
  'The Blueprint.pdf': 'Trading blueprint covering system development, backtesting, optimization, and live execution. A structured approach to building a complete trading business from the ground up.',
  'THE CANDLESTICK TRADING BIBLE.pdf': 'Complete candlestick trading system — not just pattern recognition but a full methodology. Covers market structure, trend identification, key levels, and how candlesticks confirm institutional activity.',
  'The Economics of Time and Ignorance.pdf': 'Austrian economics perspective on uncertainty, time preference, and market processes. Challenges mainstream equilibrium models and offers insights relevant to understanding real market dynamics.',
  'The High Frequency Trading Book.pdf': 'Inside look at HFT strategies, infrastructure, and market impact. Covers market making, statistical arbitrage, latency optimization, and how high-frequency firms actually generate returns.',
  'The Payoff Why Wall Street Always Wins - Jeff Connaughton.pdf': 'A Washington insider reveals how Wall Street captures regulators, writes its own rules, and socializes losses while privatizing gains. Essential reading for understanding the system you\'re trading in.',
  'The personal MBA.pdf': 'Josh Kaufman distills the core concepts of an MBA into one book — business fundamentals, marketing, sales, finance, systems thinking. The 80/20 of business education without the $200K price tag.',
  'The Theory of Money and Credit.pdf': 'Ludwig von Mises\' foundational work on monetary theory. How money originates, how credit expansion creates boom-bust cycles, and why central banking leads to systematic instability.',
  'Trade Mindfully.pdf': 'Applies mindfulness techniques to trading — meditation, present-moment awareness, and cognitive defusion. How to observe your thoughts without acting on them, reducing emotional trading.',
  'Trade Your Way to Financial Freedom.pdf': 'Van Tharp\'s complete system development framework. Position sizing, expectancy, R-multiples, and the critical insight that your trading system must match your psychology. The meta-book of trading.',
  'Way of the Turtle.pdf': 'Curtis Faith — the most successful Turtle — tells the inside story of the Turtle Trading experiment. The actual rules, the psychology of following them, and what he learned about systematic trading.',
};
...
const AXELROD_SUMMARIES: Record<string, string> = {
  ...
  // ── NEW BOOKS (from Google Drive, Mar 2026) ──
  '[Hoyt_Barber]_Tax_Havens_Today_The_Benefits_and_.pdf': `Making money is step one. Keeping it from the tax man is step two. This book lays out the LEGAL frameworks for asset protection and international diversification. Not tax evasion — tax intelligence. The ultra-wealthy don't pay more in taxes than they have to. Neither should you. Know the rules better than the people enforcing them.`,
  '7 habits of highly effective people.pdf': `Covey isn't a trader, but every habit in here maps to trading success. "Begin with the end in mind" = define your exit before entry. "Put first things first" = risk management before profit-seeking. "Sharpen the saw" = journal, review, improve. The traders who last decades live these principles. The ones who flame out ignore them.`,
  'A Random Walk Down Wall Street.pdf': `Malkiel says you can't beat the market. He's wrong — but he's useful. Understanding the efficient market hypothesis is essential because it tells you what you're up against. The market IS efficient most of the time. Your edge lives in the exceptions. Know the theory so you can exploit its blind spots.`,
  'A Short Course in Technical Trading - PERRY J KAUFMAN.pdf': `Kaufman is a quantitative legend. He doesn't trade feelings — he trades math. This distills trend-following, moving averages, and system development into a concentrated course. His adaptive moving average alone is worth studying. When a guy with 40 years of quantitative research talks, you take notes.`,
  'Candlesticks Made Easy.pdf': `The cheat sheet version of candlestick analysis. Not the 300-page deep dive — the quick-reference you pin to your monitor. Learn these patterns cold and you're reading market psychology in real time. Speed of recognition is the edge. This gets you there faster.`,
  'Daniel Reingold- Confessions of Wall Street Insider.pdf': `If you think Wall Street is looking out for you, read this and wake up. Reingold pulls back the curtain on analyst conflicts, investment bank games, and the machinery that moves prices for reasons that have nothing to do with fundamentals. Know the game. Don't be the sucker at the table.`,
  'ElWave.pdf': `Elliott Wave is either genius or astrology depending on who you ask. The truth is somewhere in between — wave analysis works when you combine it with other confirmation tools and don't try to force a count. This teaches the method without the cult. Use it as a roadmap, not a gospel.`,
  'Following The Rules.pdf': `The simplest book on this shelf and maybe the most important. Write your rules. Follow your rules. That's it. Every blown account in history started with "I'll just bend the rule this one time." Discipline isn't glamorous. Neither is consistent profitability. Both require the same muscle.`,
  'FOREX THE CORE OF PRICE ACTION WITH 3W SYSTEM - SUMIT DAS.pdf': `Where, When, What — three questions that define every trade. Das strips forex down to pure price action. No indicators, no noise, just reading what the market is telling you at key levels. The 3W system gives you a framework that works in any market, any timeframe. Simple doesn't mean easy.`,
  'Forex Wave Theory.pdf': `Wave analysis applied to the forex market — where it actually works well because currencies tend to trend in clean, measurable waves driven by central bank policy and capital flows. Elliott Wave meets forex mechanics. If you trade currencies, this is a edge multiplier.`,
  'How to Profit in Gold.pdf': `Gold is the ultimate fear trade and the ultimate store of value simultaneously. This covers every way to play it — physical, ETFs, futures, miners. But the real value is understanding WHY gold moves when it does. Inflation expectations, real rates, dollar weakness — understand the drivers and you own the trade.`,
  'Inside a Traders Mind.pdf': `This isn't about strategy — it's about the 6 inches between your ears. How winners process losing trades, how they maintain conviction during drawdowns, how they avoid euphoria after wins. The mental game is the only game. Master it or it masters you.`,
  'Investment Philosophies - Aswath Damodaran.pdf': `Damodaran is the smartest guy in any room on valuation. Here he examines EVERY investment approach with data — not opinion, DATA. Value works. Growth works. Momentum works. But each works under different conditions. The key is knowing which tool to use when. This teaches that judgment.`,
  'Law of Success.pdf': `Napoleon Hill spent 20 years interviewing Carnegie, Ford, Edison, and the titans of industry. This is the uncut version — before Think and Grow Rich condensed it. 16 principles of success that haven't changed in a century. The desire for riches is just a starting point. The principles are the path.`,
  'LEFT_Brain_Trading_the_right_mindset.pdf': `Most traders are either all analysis or all gut feel. Both fail. This teaches the integration — systematic analysis for preparation, intuition for execution. The best traders I know have both sides firing. They see the data AND feel the tape. This book bridges that gap.`,
  'MajorSignals.pdf': `A catalog of the signals that actually matter — not every blip on every indicator, but the major, high-probability signals that precede significant moves. Breakouts, reversals, divergences — each one documented with rules and stats. Your pattern recognition playbook.`,
  'Moving Averages.pdf': `The humble moving average — the most underrated tool in technical analysis. This goes deep: simple vs exponential, crossover systems, envelopes, channels. The 200-day MA moves billions in institutional money. If you don't understand why, you're trading blind.`,
  'PA.pdf': `Pure price action — no indicators, no oscillators, just price. This is how the market spoke before computers added layers of abstraction. Read the bars, read the structure, read the momentum. It's the oldest edge in trading and it still works because it's reading human behavior directly.`,
  'Price Action Trading.pdf': `A comprehensive PA methodology — candlestick patterns at key levels, market structure breaks, trend identification. When you trade price action, you're trading the decisions of every participant in the market. No indicator can give you that level of insight.`,
  'Rich Dad Poor Dad.pdf': `Kiyosaki changed how a generation thinks about money. The core insight: the rich buy assets, the poor buy liabilities they think are assets. Your house is not an asset. Your brokerage account is. Simple? Yes. Revolutionary for most people? Also yes. Read it, internalize it, act on it.`,
  'Risk_Management_in_Trading_Techniques.pdf': `Risk management isn't sexy. It doesn't get you Twitter followers. But it's the ONLY thing that keeps you in the game long enough for your edge to play out. Position sizing, correlation risk, drawdown management, portfolio heat — this is the operating manual for not going broke.`,
  'Secrets of Swiss Banking.pdf': `The Swiss built the world's most sophisticated banking system for a reason — discretion, stability, and expertise. This covers how to legally leverage Swiss financial infrastructure for diversification and asset protection. In a world of geopolitical risk, having assets in multiple jurisdictions isn't paranoia — it's prudent.`,
  'Secrets of The Millionaire Mind.pdf': `Eker nails the psychology of money. Your financial thermostat is set in childhood — and it's keeping you exactly where you are. Until you reprogram your money blueprint, no strategy will save you. You'll self-sabotage. This teaches you to identify and rewire those patterns. The inner game drives the outer results.`,
  'Sherman,_Howard_J_Economics___an.pdf': `Solid academic economics — supply, demand, monetary policy, fiscal policy. Not exciting but essential. The macro forces that drive markets are economic at their core. If you don't understand how economies work, you're trading in the dark. This turns the lights on.`,
  'Stephen_Vines_Market_Panic__Wild.pdf': `Every panic looks obvious in hindsight and terrifying in real time. Vines catalogs the great panics and extracts the patterns — what triggers them, how they cascade, and most importantly, when they exhaust. The traders who make fortunes in panics are the ones who studied them before they happened.`,
  'Supply and Demand.pdf': `The institutional fingerprint on a chart. Supply zones = where the big boys sold. Demand zones = where they loaded up. Fresh zones that haven't been tested? That's where the high-probability trades live. This teaches you to see the market through the eyes of the money that actually moves it.`,
  'The 4 Hour Work Week.pdf': `Ferriss didn't write a trading book but he wrote the entrepreneurial mindset book. Automation, delegation, 80/20 thinking. Apply this to trading: automate what can be automated, focus only on the highest-value analysis, and design your trading life so it SERVES your actual life. Work smart, trade smart.`,
  'The 4 Pillars of Profit Driven Marketing.pdf': `If you're building a business alongside trading — and you should be — this is the marketing framework. Data-driven, profit-focused, no vanity metrics. Every dollar of marketing spend should generate measurable return. Apply the same ROI discipline you use in trading to your business.`,
  'The Blueprint.pdf': `The name says it all — a step-by-step blueprint for building a trading system from scratch. Idea → backtest → optimize → execute → review → refine. Most traders skip steps 2-4 and wonder why they lose. This doesn't let you skip anything.`,
  'THE CANDLESTICK TRADING BIBLE.pdf': `Goes beyond pattern recognition into a complete candlestick trading SYSTEM. Market structure first, then key levels, then candlestick confirmation. The Bible approach: don't trade candles in isolation. Trade candles at levels where they MEAN something. Context is everything.`,
  'The Economics of Time and Ignorance.pdf': `Austrian economics applied to real markets. The key insight: the future is genuinely uncertain, not just risky. Models that assume knowable probability distributions WILL fail in extremes. Taleb built on these ideas. Understanding genuine uncertainty makes you a better risk manager.`,
  'The High Frequency Trading Book.pdf': `The machines are already in the market. This explains how they work — market making, latency arbitrage, statistical arbitrage at microsecond speed. You can't beat them at their game, but understanding their game helps you avoid their traps and exploit the dislocations they create.`,
  'The Payoff Why Wall Street Always Wins - Jeff Connaughton.pdf': `Connaughton watched from inside Washington as Wall Street wrote its own rules post-2008. Regulatory capture, revolving doors, and the systematic rigging of a system that privatizes gains and socializes losses. Understand the machine you're trading inside of. It's not fair. It was never designed to be.`,
  'The personal MBA.pdf': `Kaufman compressed a $200K MBA into one book. Business fundamentals, value creation, marketing, sales, finance, systems thinking. If you're building a trading business or any business alongside trading, this is the most efficient education you'll find. Skip the degree, read the book.`,
  'The Theory of Money and Credit.pdf': `Mises wrote the book on how money actually works — and how credit expansion creates the boom-bust cycles that move markets. Central banking, inflation, monetary policy — understand these forces and you understand the macro waves your trades are riding on.`,
  'Trade Mindfully.pdf': `Mindfulness for traders — not hippie stuff, hard science. Meditation reduces cortisol. Present-moment awareness prevents revenge trading. Cognitive defusion lets you observe fear without acting on it. The neuroscience of peak performance applied to trading. Your mind is your edge or your enemy. Choose.`,
  'Trade Your Way to Financial Freedom.pdf': `Van Tharp's masterpiece. The meta-lesson: your system must match YOUR psychology, not someone else's. Position sizing, expectancy, R-multiples, and the critical framework that ties them together. This isn't a strategy book — it's a SYSTEM-BUILDING book. That's worth 10x more.`,
  'Way of the Turtle.pdf': `Curtis Faith was the most successful Turtle and this is his side of the story. Not just the rules — the EXPERIENCE. What it felt like to follow the system during drawdowns, how discipline was maintained, and the psychological battles that separated the Turtles who made millions from those who didn't. First-person proof that systems work.`,
};
