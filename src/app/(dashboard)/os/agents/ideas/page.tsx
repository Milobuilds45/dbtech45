...
const T: Record<string, Record<CreativityLevel, IdeaTemplate>> = {
  ...
  tony: {
    simple: {
      title: 'PulseCheck Kitchen',
      description: 'Simple daily tracking for food costs, sales, and basic restaurant metrics. No complexity, just the numbers that matter. Built by someone who has run kitchens for 40 years.',
      ...
      revenueProjection: 'Conservative: $104K/yr (300 subs). Moderate: $209K/yr (600 subs). Aggressive: $522K/yr (1,500 subs)',
      competitiveAdvantage: 'Designed for mom-and-pop restaurants, not chains. 5-minute daily input.',
      developmentTime: '24 hours for MVP (mobile-first tracker + basic charts). 3-5 days to polish and add reports.',
    ...
    creative: {
      title: 'ZeroWaste AI',
      description: 'Smart system that predicts demand and optimizes prep schedules to eliminate food waste and reduce labor costs. Turns your kitchen into a precision operation.',
      ...
      revenueProjection: 'Conservative: $360K/yr (60 restaurants). Moderate: $1.2M/yr (200 restaurants). Aggressive: $3M/yr (500 restaurants)',
      competitiveAdvantage: 'First AI specifically trained on restaurant kitchen operations and waste patterns',
      developmentTime: '3-5 days for core prediction engine + POS connector. 2 weeks to train on real kitchen data and refine.',
    ...
    experimental: {
      title: 'KitchenSwap',
      description: 'AI that dynamically matches ghost kitchen capacity with real-time delivery demand across a metro area. Uber for kitchen capacity. Empty ovens meet hungry customers.',
      ...
      revenueProjection: 'Conservative: $600K/yr (50 kitchens). Moderate: $3M/yr (200 kitchens). Aggressive: $8M/yr (500+ kitchens at network scale)',
      competitiveAdvantage: 'First network-level optimization for ghost kitchen capacity matching',
      developmentTime: '1 week for matching MVP + basic logistics. 2-3 weeks for delivery integrations and real-time optimization.',
