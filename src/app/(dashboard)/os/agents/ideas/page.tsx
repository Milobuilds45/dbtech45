...
const T: Record<string, Record<CreativityLevel, IdeaTemplate>> = {
  bobby: {
    simple: {
      ...
      revenueProjection: '1,500 people paying $19/month equals $285,000 per year in recurring revenue',
      ...
      developmentTime: '3-4 weeks using AI to build the alert system and mobile app',
  ...
  paula: {
    simple: {
      ...
      revenueProjection: '800 people buying the premium version monthly at $19 each equals $152,000 per year',
      ...
      developmentTime: '2-3 weeks using AI to build the logo generator and instant download system',
  ...
  anders: {
    ...
    creative: {
      ...
      revenueProjection: '500 businesses paying an average of $133/month equals $798,000 in annual revenue',
      ...
      developmentTime: '6-8 weeks using AI to build the visual editor and automatic deployment system',
  ...
  milo: {
    simple: {
      ...
      revenueProjection: '1,200 small businesses at $29/month equals $348,000 in annual recurring revenue',
      ...
      developmentTime: '3-4 weeks using AI to build the tracking system and simple dashboard',
