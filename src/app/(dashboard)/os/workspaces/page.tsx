  ...
  return (
    <div style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ marginBottom: '2rem' }}>
        <span style={{ color: '#F59E0B', fontFamily: "'JetBrains Mono', monospace", fontSize: '0.875rem' }}>&gt; ops --workspaces</span>
        <h1 style={{ fontSize: '2rem', fontWeight: 700, color: '#FAFAFA', margin: '0.25rem 0 0' }}>Workspaces</h1>
        <p style={{ color: '#71717A', fontSize: '0.875rem', marginTop: '0.25rem' }}>Persistent agent identities, models, tools, and memory configuration</p>
      </div>
