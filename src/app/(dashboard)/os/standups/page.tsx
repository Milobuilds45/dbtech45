  ...
  return (
    <div style={{ padding: '2rem', maxWidth: 1400, margin: '0 auto', fontFamily: "'Inter', sans-serif" }}>
      <div style={{ marginBottom: '2rem' }}>
        <span style={{ color: '#F59E0B', fontFamily: "'JetBrains Mono', monospace", fontSize: '0.875rem' }}>&gt; ops --standups</span>
        <h1 style={{ fontSize: '2rem', fontWeight: 700, color: '#FAFAFA', margin: '0.25rem 0 0' }}>Standups & AI Meetings</h1>
        <p style={{ color: '#71717A', fontSize: '0.875rem', marginTop: '0.25rem' }}>Multi-agent conversations, transcripts, and action items</p>
      </div>
