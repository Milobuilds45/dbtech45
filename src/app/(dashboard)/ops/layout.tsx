...
const navItems = [
  ...
  { label: 'Projects', href: '/ops/projects', icon: FolderKanban },
  { label: 'Ship or Kill', href: '/ops/ship-or-kill', icon: Ship },
  { label: 'Newsletter', href: '/ops/newsletter', icon: Mail },
  { label: 'Apex Trader', href: '/ops/apex', icon: BarChart3 },
  { label: 'Markets', href: '/ops/markets', icon: TrendingUp },
  { label: 'AxeCap Terminal', href: '/ops/axecap', icon: Activity },
  { label: 'Finance Library', href: '/ops/finance-library', icon: BookOpen },
  { label: 'Clipd', href: '/ops/clipd', icon: Youtube },
  { label: 'Kanban', href: '/ops/kanban', icon: LayoutDashboard },
  { label: 'Calendar', href: '/ops/calendar', icon: CalendarDays },
  { label: 'Ideas Vault', href: '/ops/ideas-vault', icon: Lightbulb },
  { label: 'Research', href: '/ops/research', icon: Search },
  { label: 'DNA Scanner', href: '/ops/dna-scanner', icon: Dna },
  { label: 'X Clipd', href: '/ops/x-clipd', icon: Twitter },
];
