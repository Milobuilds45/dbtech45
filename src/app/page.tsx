...
const projects = [
  ...
  },
  {
    id: "tradecraft",
    title: "TradeCraft",
    description: "My world in trading: ideas, charting, strategy tests & prop firm journey.",
    icon: "📈",
    href: "/tradecraft",
  ...
  {
    id: "playmaker-zone",
    title: "Playmaker Zone",
    description: "Sports analytics to help with betting, mock drafts & gaming experiments.",
    icon: "🎮",
    href: "/playmaker-zone",
  ...
  },
  {
    id: "brain-dump",
    title: "Brain Dump",
    description: "The messy-mind vault: bookmarks, gadgets & random sparks of inspiration.",
    icon: "🧠",
    href: "/brain-dump",
