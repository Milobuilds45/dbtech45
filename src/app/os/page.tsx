          ...
          <section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {responses.map((response) => (
                ...
                >
                  {/* Response Header - Clickable to collapse */}
                  <button
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {/* Collapse Arrow */}
                      <svg 
                        className={`w-3 h-3 text-[#505470] transition-transform duration-200 ${collapsed[response.modelId] ? '' : 'rotate-90'}`}
                        fill="currentColor" 
                        viewBox="0 0 20 20"
                      >
